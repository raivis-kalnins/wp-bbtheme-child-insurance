...
## 3.8.10.46
- Replaces inherited technology artwork with family, home and motor-insurance imagery throughout the bundled demo media.
...
- Insurance product pages receive complete demo content and refreshed product imagery on import.
...
## 3.7.0
- Initial sector child theme for the v3.7 theme suite.
## 3.8.10.11
